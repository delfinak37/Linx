![изображение](https://github.com/user-attachments/assets/0849843e-7e78-46f0-bd3b-2a64548fafab)# Безопасная среда сайта "В гостях у троллей"

## Постановка задачи
Задача заключается в реализации безопасной среды сайта по настольным играм «В гостях у троллей». Сайт реализует следующий функционал.
